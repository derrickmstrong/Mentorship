...
const db = new sqlite3.Database('mydatabase.db'); // Database name
...
const insertData = () => {
  ...
  db.run(
    `INSERT INTO orders (user_id, order_date, amount) VALUES (1, '2023-07-01', 99.99)`
  );
  db.run(
    `INSERT INTO orders (user_id, order_date, amount) VALUES (2, '2023-07-02', 149.99)`
  );
};
